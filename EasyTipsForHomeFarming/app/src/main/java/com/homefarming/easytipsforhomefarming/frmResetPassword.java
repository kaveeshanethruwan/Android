            ...
            btnverify.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(email.getText().toString().equals("")){
                        ...
                        Toast.makeText(frmResetPassword.this, "Provide your email", Toast.LENGTH_SHORT).show();

                    }
                    else if(! isEmailValid(email.getText().toString())){
                        Toast.makeText(frmResetPassword.this, "Invalid email", Toast.LENGTH_SHORT).show();
        ...
        firebaseAuth.fetchSignInMethodsForEmail(email.getText().toString()).addOnCompleteListener(new OnCompleteListener<SignInMethodQueryResult>() {
            ...
            public void onComplete(@NonNull Task<SignInMethodQueryResult> task) {
                ...
                if (task.getResult().getSignInMethods().size() == 0){
                    Toast.makeText(frmResetPassword.this, "No user found", Toast.LENGTH_SHORT).show();
                    mProgressCircle.setVisibility(View.GONE);
        ...
        firebaseAuth.sendPasswordResetEmail(email.getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(frmResetPassword.this, "Some thing went wrong", Toast.LENGTH_LONG).show();
                    mProgressCircle.setVisibility(View.GONE);
